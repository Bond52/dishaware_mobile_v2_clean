...
class OnboardingStep10 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final selected = onboardingProvider.data.texturePreference;
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Ce qui te fait aimer un plat en premier, c’est surtout :',
            style: TextStyle(
              fontSize: 22,
          ...
          const Text(
            'La texture qui vous fait plaisir',
            style: TextStyle(
              fontSize: 15,
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                return _SelectableCard(
                  ...
                  selected: isSelected,
                  onTap: () =>
                      onboardingProvider.setTexturePreference(option.title),
                );
              },
            ),
          ),
