...
class OnboardingStep4 extends StatelessWidget {
  ...
  static const Map<String, String> _dietIcons = {
    'Végétarien': '🥬',
    'Végan': '🌱',
    'Pescétarien': '🐟',
    'Sans gluten': '🌾',
  ...
  Widget build(BuildContext context) {
    ...
    final selected = onboardingProvider.data.dietaryPreferences;
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  onTap: () => onboardingProvider.toggleDietaryPreference(diet),
                  child: Container(
