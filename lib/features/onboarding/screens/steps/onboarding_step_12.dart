...
class OnboardingStep12 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final selected = onboardingProvider.data.diningContext;
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Tu manges le plus souvent à l’extérieur quand tu es :',
            style: TextStyle(
              fontSize: 24,
          ...
          const Text(
            'Votre contexte habituel de consommation',
            style: TextStyle(
              fontSize: 15,
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                return _SelectableCard(
                  ...
                  selected: isSelected,
                  onTap: () =>
                      onboardingProvider.setDiningContext(option.title),
                );
              },
            ),
          ),
