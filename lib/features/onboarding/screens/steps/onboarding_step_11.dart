...
class OnboardingStep11 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final selected = onboardingProvider.data.satietyAfterMeal;
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Après un bon repas, tu veux te sentir :',
            style: TextStyle(
              fontSize: 24,
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                return _SelectableCard(
                  ...
                  selected: isSelected,
                  onTap: () =>
                      onboardingProvider.setSatietyAfterMeal(option.title),
                );
              },
            ),
          ),
